"""Change device history key and remove id

Revision ID: acdd6468e03f
Revises: 8c74e5e61415
Create Date: 2025-03-30 20:20:27.510066
...
revision: str = 'acdd6468e03f'
down_revision: Union[str, None] = '8c74e5e61415'
...
def upgrade() -> None:
    ...
    op.drop_table('alembic_version_xxx')
...
def downgrade() -> None:
    ...
    op.create_table('alembic_version_xxx',
    sa.Column('version_num', sa.VARCHAR(length=32), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('version_num', name='alembic_version_pkc')
    )
