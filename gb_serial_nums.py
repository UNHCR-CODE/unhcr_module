...
def get_gb_user_info_data(csv_file):
    url = "https://api.eyedro.com/Unhcr//UserInfo?UserKey=UCL6TJbxZX7QPiMpNbKn42LoN7Jf6pXTcPkYcLjU"
...
# all_serials = get_gb_user_info_data(all_api_gbs_csv)
#     # Print the result
# x = 1
# for item in all_serials:
#     print(f" {x}  site_label: {item[0] if item[0] else 'N/A'}, device_serial: {item[1]}")
#     x += 1
# #!!!!! gen all_api_gbs csv with eyedro label & serial
